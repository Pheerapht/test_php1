...
//connect db
	...
	$sql = "select * from product2 where p_id=$p_id";  //รับค่าตัวแปร p_id ที่ส่งมา
	...
	echo "<br><br><br>";
    echo "<a href='cart1.php?p_id=$row[p_id]&act=add'> เพิ่มลงตะกร้าสินค้า </a></td>";
    echo "</tr>";
?>
</table>

<br><br><br><br>
<p><center><a href="link1.php">กลับไปหน้ารายการสินค้า</a></center>
